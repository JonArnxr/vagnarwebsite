        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 bg-blue-600/20 border border-blue-500/30 px-4 py-2 mb-6">
              <span className="text-blue-400 text-sm font-medium tracking-wide">Samband</span>
            </div>
            <h1 className="text-4xl lg:text-5xl font-bold mb-6 leading-tight">
              Hafðu samband á<br />
              <span className="text-blue-500">við okkur</span>
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="bg-white p-8">
              <h2 className="text-2xl font-bold text-stone-900 mb-6">Sendu okkur skilaboð</h2>
              <form className="space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      name="name"
                      required
                      className="w-full px-4 py-3 border border-stone-300 bg-stone-50 focus:outline-none focus:border-blue-500 focus:bg-white transition-colors"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={6}
                    required
                    className="w-full px-4 py-3 border border-stone-300 bg-stone-50 focus:outline-none focus:border-blue-500 focus:bg-white transition-colors resize-none"
            ...
            <div className="space-y-6">
              <div className="bg-white p-8">
                <h2 className="text-2xl font-bold text-stone-900 mb-6">Tengiliðaupplýsingar</h2>
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-bold text-stone-900 mb-1">Staðsetning</h3>
                      <p className="text-stone-600">Tunguháls 10</p>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="tel:5673440" className="text-blue-600 hover:text-blue-700 font-medium">567-3440</a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:vagnar@vagnar.is" className="text-blue-600 hover:text-blue-700 font-medium">vagnar@vagnar.is</a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-bold text-stone-900 mb-1">Opnunartími</h3>
                      <p className="text-stone-600">Mánudagur - Föstudagur</p>
                      <p className="text-stone-600">08:00 - 16:00</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-stone-900 p-8 text-white">
                <h3 className="font-bold text-lg mb-4">Finndu okkur</h3>
