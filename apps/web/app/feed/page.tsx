        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl">
            <div className="inline-flex items-center gap-2 bg-blue-600/20 border border-blue-500/30 px-4 py-2 mb-6">
              <span className="text-blue-400 text-sm font-medium tracking-wide">Fréttir</span>
            </div>
            <h1 className="text-4xl lg:text-5xl font-bold mb-6 leading-tight">
              Fréttir og<br />
              <span className="text-blue-500">verkefni</span>
            </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {posts.length > 0 ? (
                ...
                return (
                  ...
                  >
                    {firstImage ? (
                      ...
                      <div className="w-full aspect-[16/10] bg-stone-200 flex items-center justify-center">
                    ...
                    <div className="p-6">
                      ...
                      <h3 className="text-lg font-bold mb-2 text-stone-900 mt-2 group-hover:text-blue-600 transition-colors">
                        {post.title}
                      </h3>
            ...
            <div className="text-center py-16">
              <div className="w-16 h-16 bg-stone-200 flex items-center justify-center mx-auto mb-6">
                <svg className="w-8 h-8 text-stone-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9a2 2 0 00-2-2h-2m-4-3H9M7 16h6M7 8h6v4H7V8z" />
                </svg>
              </div>
              <h2 className="text-xl font-bold text-stone-900 mb-2">Engar fréttir enn</h2>
              <p className="text-stone-600">Fréttir og verkefni birtast hér þegar þau eru tilbúin.</p>
            </div>
          )}
        </div>
      </section>
