  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative bg-stone-900 text-white overflow-hidden min-h-[550px] lg:min-h-[700px]">
        <Image
          src="/images/dhollandiaHero.png"
          alt="Dhollandia vörulyfta"
          fill
          priority
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="aspect-video rounded-2xl overflow-hidden relative">
              <Image
                src="/images/dhollandiaSmallPhoto.jpeg"
                alt="Dhollandia vörulyfta"
                fill
              ...
              <div className="absolute inset-0 flex items-center justify-center text-center">
                <div>
                  <span className="text-white text-4xl font-bold tracking-wider">DHOLLANDIA</span>
                  <p className="text-stone-300 mt-2 text-sm">Viðurkenndur dreifingaraðili á Íslandi</p>
                </div>
              </div>
            </div>
          </div>
